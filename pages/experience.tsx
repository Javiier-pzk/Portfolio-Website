          ...
          {isWorldQuant && (
            <WorkDetails
              ...
              jobDescriptions={[
                ...
                "Took ownership of Alpha Analyzer within one month of joining and led end-to-end development as the primary project owner and developer; delivered a production-grade alpha visualization, analysis and comparison platform used by Quant Macro portfolio managers and researchers, supporting single-alpha analysis, multi-alpha benchmarking, and instrument-level breakdowns.",
