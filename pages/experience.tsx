          ...
          {isWorldQuant && (
            <WorkDetails
              ...
              jobDescriptions={[
                ...
                "Led end-to-end development of Alpha Analyzer, a production-grade alpha visualization, analysis, and comparison tool supporting single-alpha deep dives, multi-alpha benchmarking, and instrument-level breakdowns; took ownership of the project within one month of joining and served as the primary developer and maintainer through production rollout.",
                "Improved intraday tick data access performance by 10x by designing and implementing a caching layer with a background daemon to stream live time-series updates into an internal cache storage, significantly reducing repeated database reads.",
